...
export default function Header({ onMenuToggle, isCollapsed }) {
  ...
  return (
    <header
      className={`
      sticky top-0 z-30 bg-white dark:bg-primary-900 border-b border-gray-200 dark:border-primary-700 
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className={`hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold uppercase tracking-wider ${
            ...
            <span className={`w-1.5 h-1.5 rounded-full animate-pulse ${
              ACTIVE_NETWORK.isLocalhost ? "bg-accent-500" : "bg-tertiary-500"
            }`} />
