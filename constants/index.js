...
export const MILESTONE_MANAGER_ADDRESS = process.env.NEXT_PUBLIC_MILESTONE_MANAGER_ADDRESS;
...
if (typeof window !== "undefined") {
  if (!CONTRACT_ADDRESS) console.error("NEXT_PUBLIC_CONTRACT_ADDRESS is not set");
  if (!MILESTONE_MANAGER_ADDRESS) console.error("NEXT_PUBLIC_MILESTONE_MANAGER_ADDRESS is not set");
}

export const PINATA_CONFIG = { pinataApiKey: PINATA_API_KEY, pinataSecretApiKey: PINATA_SECRET_KEY, pinataJWT: PINATA_JWT };

export const NETWORK_CONFIGS = {
  localhost: { name: "Localhost", chainId: 31337, rpcUrl: "http://localhost:8545", blockExplorer: "http://localhost:8545" },
  holesky: { name: "Holesky Testnet", chainId: 17000, rpcUrl: "https://ethereum-holesky.publicnode.com", blockExplorer: "https://holesky.etherscan.io" },
  sepolia: { name: "Sepolia Testnet", chainId: 11155111, rpcUrl: "https://eth-sepolia.g.alchemy.com/v2/YJGj5hyqrUOA3m8a8qmge", blockExplorer: "https://sepolia.etherscan.io" },
};
