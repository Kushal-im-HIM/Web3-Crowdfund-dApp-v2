          ...
          <div className="bg-white dark:bg-primary-800 rounded-xl shadow-slate-soft p-6 border border-gray-100 dark:border-primary-700">
            <div className="flex items-center justify-between">
              ...
              <div className="w-12 h-12 bg-secondary-50 dark:bg-secondary-900/20 rounded-lg flex items-center justify-center">
                <FiDollarSign className="w-6 h-6 text-secondary-600 dark:text-secondary-400" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-primary-800 rounded-xl shadow-slate-soft p-6 border border-gray-100 dark:border-primary-700">
            <div className="flex items-center justify-between">
              ...
              <div className="w-12 h-12 bg-tertiary-50 dark:bg-tertiary-900/20 rounded-lg flex items-center justify-center">
                <FiHeart className="w-6 h-6 text-tertiary-600 dark:text-tertiary-400" />
              </div>
            </div>
          </div>
        ...
        {loading ? (
          <div className="space-y-4">
            {[...Array(5)].map((_, i) => (
              <div
                key={i}
                className="bg-white dark:bg-primary-800 rounded-xl shadow-slate-soft border border-gray-100 dark:border-primary-700 p-6 animate-pulse"
              >
                <div className="flex items-center space-x-4">
                  <div className="w-16 h-16 bg-gray-200 dark:bg-primary-700 rounded-lg"></div>
                  <div className="flex-1 space-y-2">
                    <div className="h-4 bg-gray-200 dark:bg-primary-700 rounded w-1/3"></div>
                    <div className="h-4 bg-gray-200 dark:bg-primary-700 rounded w-1/2"></div>
                  </div>
                </div>
              </div>
            ))}
            ...
            <div className="divide-y divide-gray-200 dark:divide-primary-700">
              {contributions.map((contribution, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="p-6 hover:bg-gray-50 dark:hover:bg-primary-700/30 transition-colors"
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        <div className="w-12 h-12 bg-gradient-to-r from-secondary-500 to-tertiary-500 rounded-lg flex items-center justify-center">
